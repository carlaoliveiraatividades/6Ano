...
export const DEMO_STUDENT: User = {
  id: 'aluno-alex',
  nickname: 'Cyber_Alex_104',
  username: 'alex.silva',
  name: 'Alex Ramos',
  email: 'alex.ramos@escola.pt',
  role: 'student',
  avatar: 'alex',
  classId: 'turma-6a',
  className: '6.º A',
